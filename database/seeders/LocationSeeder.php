...
JSON;
        ...
        $locations = json_decode($json, true)['results'];
        ...
        foreach ($locations as $location) {
            ...
            if (!empty($location['residents']) && is_array($location['residents'])) {
                foreach ($location['residents'] as $resident_url) {
                    $resident_id = (int) basename($resident_url);
                    DB::table('character_location')->insert([
                        'location_id' => $loc->id,
